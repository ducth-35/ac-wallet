...
function cloneObject(data) {
    ...
    if (!['Set', 'Map', 'Object', 'Date', 'Array'].includes((_c = data.constructor) === null || _c === void 0 ? void 0 : _c.name)) {
        return data;
    }
    ...
    if (data instanceof Map) {
        copy = new Map();
        try {
            for (var _d = __values(data.keys()), _e = _d.next(); !_e.done; _e = _d.next()) {
                var key = _e.value;
...
function useForm(_a) {
    ...
    var setInternalValue = React.useCallback(function (name, value, config) {
        ...
        !shouldUnregister &&
            !isPrimitive(value) &&
            set(shallowFieldsStateRef.current, name, Array.isArray(value) ? __spread(value) : __assign({}, value));
        if (fieldsRef.current[name]) {
...
var removeArrayAt = (function (data, index) {
    return isUndefined(index)
        ? []
        : removeAtIndexes(data, (Array.isArray(index) ? index : [index]).sort(function (a, b) { return a - b; }));
});
...
var useFieldArray = function (_a) {
    ...
    var append = function (value, shouldFocus) {
        ...
        var updateFormValues = compact(__spread(getCurrentFieldsValues(), mapIds(appendValue, keyName)));
