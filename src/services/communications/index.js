...
export const text = function (phoneNumber = null, body = null) {
  ...
  if (phoneNumber) {
    if (isCorrectType('String', phoneNumber)) {
      ...
      console.log(
        'the phone number should be provided as a string. It was provided as ' +
  ...
  if (body) {
    if (isCorrectType('String', body)) {
      ...
      console.log(
        'the body should be provided as a string. It was provided as ' +
...
export const openWeb = (address = null) => {
  if (!address) {
  ...
  if (!isCorrectType('String', address)) {
    console.log(
      'address was not provided as a string, it was provided as ' +
...
export default { phonecall, text, textWithoutEncoding, sendEmail, openWeb };
